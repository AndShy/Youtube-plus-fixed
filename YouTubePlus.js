    ...
    var particle = {
        inject: function(is_userscript) {
                ...
                if (section === "MEN") {
                    ...
                    temp.innerHTML = //
                        "<div id='P-content'>" +
							...
							"<div><input id='VID_LAYT_LIVE_CHAT' type='checkbox'><label for='VID_LAYT_LIVE_CHAT' data-p='tnd|VID_LAYT_LIVE_CHAT'></label>\n</div>" +
                        "</div>";
                    if (user_settings.GEN_LOCL_LANG && user_settings.localLang) {
                        temp.content.querySelector(".P-implang").dataset.p = "GLB_LOCL_LANG_CSTM";
                    }
            ...
            function generalChanges() {
				...
				if (user_settings.VID_LAYT_LIVE_CHAT && window.location.pathname === "/watch" && livechat) {
					livechat.classList.add("yt-uix-expander-collapsed");
				}
            }
            ...
            language = {
                ...
                LOCALE                : "English (US)",
				VID_LAYT_LIVE_CHAT    : "Auto collapse LIVE chat"
            };
